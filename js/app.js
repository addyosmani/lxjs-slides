...
function initContent(e) {
  ...
  slidedeck.container.listen('slideenter', function(e) {
    ...
    if(slide.classList.contains('io-avatar')){
      var sel = slide.querySelector('.io-avatar-slide');
      sel.style.webkitMaskSize = '1800px';
    }
...
/*
    if (slide.classList.contains('coverslide')) {
      var h1 = slide.querySelector('h1');
      h1.style.transitionProperty = 'transform';
      h1.style.transitionDuration = '900ms';
      h1.style.transitionDelay = '600ms';
      h1.style.transform = 'translate(0px, 500px)';  

      var h2 = slide.querySelector('h2');
      h2.style.transitionProperty = 'transform';
      h2.style.transitionDuration = '1200ms';
      h2.style.transitionDelay = '900ms';
      h2.style.transform = 'translate(0px, 120px)'

      var cs = slide.querySelector('#coverstory');
      cs.style.transitionProperty = 'transform';
      cs.style.transitionDuration = '1200ms';
      cs.style.transitionDelay = '1800ms';
      cs.style.transform = 'translate(0px, 0px)'; 

    }*/

    if (slide.classList.contains('profile')) {
      var who = slide.querySelector('#who-qp');
      who.style.transitionProperty = 'transform';
      who.style.transitionDuration = '1500ms';
      who.style.transform = 'translate(0px, 450px)';

/*
      var player = document.timeline.play(new Animation(who, [
          //{transform: 'translate3d(0, -100px, 0)'}, {transform: 'height:200px'}
          { transform: 'translate(0, 500px)'}
        ],
        {
           duration: 1000, delay: 10, direction: "alternate", fill:"none"
        }));
*/
    }
  });
...
*/
  (function() {
    ...
    var flexLayout = output.querySelector('#flexlayout');
    var flexDiv = flexLayout.querySelector('div[flex]');
    var horizontal = demo.querySelector('[data-action="horizontal"]');
    ...
    horizontal.listen('click', function(e) {
      if(flexLayout.getAttribute('vertical') == null && flexLayout.getAttribute('horizontal') == "" || flexLayout.getAttribute('horizontal') == "true"){
        flexLayout.removeAttribute('horizontal', true);
        flexLayout.setAttribute('vertical', true);  
        horizontal.innerText = 'vertical';     
      } else if(flexLayout.getAttribute('vertical') == "true" && flexLayout.getAttribute('horizontal') == null){
        flexLayout.removeAttribute('vertical', true);
        flexLayout.setAttribute('horizontal', true);  
